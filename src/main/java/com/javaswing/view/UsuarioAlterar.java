...
public class UsuarioAlterar extends javax.swing.JFrame {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        usuario.setCodigo(Integer.parseInt(txtCodigo.getText()));
        usuario.setNome(txtTitulo.getText());
        usuario.setTelefone(txtAutor.getText());
        usuario.setCidade(txtEditora.getText());        
        try {
            if(usuarioControle.atualizar(usuario) == false){
                JOptionPane.showMessageDialog(null,"Usuario Alterado com Sucesso!","ATENÇÃO",JOptionPane.INFORMATION_MESSAGE);
                                
            }else{
                JOptionPane.showMessageDialog(null,"ERRO; Usuario não foi alterado !","ATENÇÃO",JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (SQLException ex) {
